    ...
    public function run(): void
    {
        $slides = [
            [
                ...
                'cta_link' => '/catalog',
                'image_url_desktop' => 'https://via.placeholder.com/1920x600?text=Hero+Juguetes',
                'image_url_mobile' => 'https://via.placeholder.com/768x500?text=Hero+Juguetes+Mobile',
            ...
            [
                ...
                'image_url_desktop' => 'https://via.placeholder.com/1920x600?text=Dia+del+Nino',
                'image_url_mobile' => 'https://via.placeholder.com/768x500?text=Dia+del+Nino+Mobile',
            ...
            [
                ...
                'image_url_desktop' => 'https://via.placeholder.com/1920x600?text=Juguetes+Educativos',
